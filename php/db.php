<?php
	...
	function sql_select($tabelle, $felder = "*", $where_string = "", $show_empty = false, $orderBY = "") {
	    // Select Abfrage
	    $sql_felder = "";
	    $return_array = array();
	    if (is_array($felder)) {
    ...
    $datenbank = new db("mysql", "localhost", "SimpleRpg", "123456");
    $datenbank->connect_db("SimpleRpg");
    $datenbank->set_utf8();
?>